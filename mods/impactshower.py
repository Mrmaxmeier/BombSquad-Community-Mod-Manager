...
def bsGetGames():
    return [ImpactShowerGame]

def bsGetLevels():
    return [bs.Level('Impact Shower',displayName='${GAME}',gameType=ImpactShowerGame,settings={},previewTexName='rampagePreview'),
            bs.Level('Epic Impact Shower',displayName='${GAME}',gameType=ImpactShowerGame,settings={'Epic Mode':True},previewTexName='rampagePreview')]

class ImpactShowerGame(bs.TeamGameActivity):
